														...
														<div class="bristou-post">
															<div class="post-img"><a href="<?php the_permalink(); ?>" title=""><?php the_post_thumbnail();?></a></div>
																<?php
																	...
																	$output_single_post ='';
																	if($categories_single_post){
																		foreach($categories_single_post as $cate){
																			$output_single_post .= '<a class="cat" href="'. get_category_link( $cate->term_id ) .'" style="display:inline!important;">' . $cate->cat_name .'<a/>' . $seprator_single_post;
																		}
																		echo trim($output_single_post, $seprator_single_post);
																	}
																?>
															...
															<p>
																<a class="simple-btn" href="<?php the_permalink();?>" title="">Continue Reading</a>
															</p>
