						...
						<div class="container">
							<div class="row">
								<div class="custom-grid1 bristou-col">
									<?php
										$args_about_the_author = array(
											'post_type'=>'about_the_author'
										);
										$about_me_section = new WP_Query( $args_about_the_author );
										if( $about_me_section->have_posts()){
											while($about_me_section->have_posts()){
												$about_me_section->the_post();
												?>
													<div class="about-page">
														...
														<div class="share-post">
															<?php
																$value_social_media_about_the_author = get_field('social_media');

																if( in_array('facebook', $value_social_media_about_the_author) ){
																	?>
																		<a href="<?php the_field('facebook_link'); ?>" title=""><i class="fa fa-facebook"></i></a>
																	<?php
																}
																if( in_array('twitter', $value_social_media_about_the_author) ){
																	?>
																		<a href="<?php the_field('twiiter_link'); ?>" title=""><i class="fa fa-twitter"></i></a>
																	<?php
																}
																if( in_array('pinterest', $value_social_media_about_the_author) ){
																	?>
