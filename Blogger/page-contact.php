								...
								<div class="custom-grid1 bristou-col">
									<?php
										$args_about_the_author = array(
											'post_type'=>'contact_section_info'
										);
											...
											while($about_me_section->have_posts()){
												...
												?>
													<div class="about-page">
														...
														<form>
															<input type="text" placeholder="<?php the_field('name');?>" />
															<input type="email" placeholder="<?php the_field('email');?>" />
															<textarea placeholder="<?php the_field('message');?>"></textarea>
